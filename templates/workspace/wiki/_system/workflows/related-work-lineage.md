...
Boundary: do not append graph events, create D*, mutate Zotero, mark sources project-core/global-core, or treat output as Project Understanding Graph truth. Dashboard views are read-only observers.
