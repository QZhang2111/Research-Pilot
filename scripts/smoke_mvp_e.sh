...
python3 tools/source_intake_cli.py status --repo "$tmp_workspace" --json >/tmp/research-pilot-mvp-e-status.json
...
rg -n '"mode": "manual-source-identity"' /tmp/research-pilot-mvp-e-status.json >/dev/null
