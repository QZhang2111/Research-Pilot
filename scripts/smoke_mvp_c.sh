...
python3 tools/graph_delta_cli.py dry-run --repo "$tmp_workspace" --project DemoProject --delta examples/demo/deltas/refine-demo-claim.json --json >/tmp/research-pilot-mvp-c-dry-run.json
python3 tools/graph_delta_cli.py register --repo "$tmp_workspace" --project DemoProject --delta examples/demo/deltas/refine-demo-claim.json --json >/tmp/research-pilot-mvp-c-register.json
